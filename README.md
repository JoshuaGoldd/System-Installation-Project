...
![Administrator PowerShell window with blue background and green text prompt showing C:\Windows\system32>](/system-installation-project/Images/image-9.png)

- Install Windows Terminal from Microsoft Store(Optional but recommended)
- Open and run it in Administrator mode.

![screenshot image](/system-installation-project/Images/image-19.png)
